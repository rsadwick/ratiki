...
namespace Platformer
{
    ...
    class Enemy
    {
        ...
        /// </summary>
        public Enemy(Level level, Vector2 position, string spriteSet, TileCollision collision)
        {
            this.IsAlive = true;
            this.level = level;
        ...
        public void LoadContent(string spriteSet)
        {
            ...
            runAnimation = new Animation(Level.Content.Load<Texture2D>(spriteSet + "Run2"), 0.1f, true);
            idleAnimation = new Animation(Level.Content.Load<Texture2D>(spriteSet + "Run2"), 0.15f, true);
            deathAnimation = new Animation(Level.Content.Load<Texture2D>(spriteSet + "Death"), 0.07f, false);
            sprite.PlayAnimation(idleAnimation);

            //Sound
            killedSound = Level.Content.Load<SoundEffect>("Sounds/BaddieDeath");
